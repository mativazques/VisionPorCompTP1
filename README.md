...
```
cd existing_repo
git remote add origin https://gitlab.com/vpc-mat-asvazques/tp1.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/vpc-mat-asvazques/tp1/-/settings/integrations)
